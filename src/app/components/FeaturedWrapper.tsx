    ...
    <div className="flex gap-3">
      ...
      <div className="flex-flex-col gap-3">
        ...
        <div className="flex gap-3 items-center">
          ...
          <h4 className="text-xs font-semibold text-color8">
            {packageData.night}N/{packageData.day}D
          </h4>
        </div>
        ...
        <div className="flex mt-6 justify-between">
          <div className="flex flex-col">
            <div className=" font-medium text-color10 relative w-[6.5rem]">
              Rs. {packageData.price}
              <div className="absolute h-[2px] w-full bg-red-500 top-1/2"></div>
            </div>
            <div className="text-color9 text-2xl font-semibold">
