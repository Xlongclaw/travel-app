import { getHeroImageCarouselData, getPackagesByCategory } from "../../sanity/sanity.query";
...
export default async function Home() {
  ...
  return (
    <main className="flex flex-col">
      ...
      <FeaturedSection featuredPackagesData={JSON.stringify(featuredPackagesData)}/>
      <Footer/>
    </main>
  );
}
